...
//ejsが更新されたか監視
gulp.task("ejs-watch", () => {
  return gulp.watch("./src/ejs/**/*.ejs", gulp.task("ejs"));
});
...
// タスクの定義。
gulp.task("webpack", () => {
  return webpackStream(gulpIf(isProd, webpackProdConfig, webpackDevConfig), webpack) // webpackStreamの第2引数にwebpackを渡す
